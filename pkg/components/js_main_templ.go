...
func mainJS() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_mainJS_047d`,
		Function: `function __templ_mainJS_047d(){async function closeLoadingPage()
    {
    ...
    function scrollBarProgress()
    {
		...
		Call:       templ.SafeScript(`__templ_mainJS_047d`),
		CallInline: templ.SafeScriptInline(`__templ_mainJS_047d`),
	}
}
